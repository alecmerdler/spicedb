...
func (r *natsReader) ReadCaveatByName(_ context.Context, name string) (*core.CaveatDefinition, datastore.Revision, error) {
	r.mustLock()
	defer r.Unlock()
...
func (r *natsReader) readCaveatByName(tx *memdb.Txn, name string) (*caveat, datastore.Revision, error) {
...
func (r *natsReader) readUnwrappedCaveatByName(tx *memdb.Txn, name string) (*core.CaveatDefinition, datastore.Revision, error) {
...
func (r *natsReader) ListAllCaveats(_ context.Context) ([]datastore.RevisionedCaveat, error) {
	r.mustLock()
	defer r.Unlock()
...
func (r *natsReader) LookupCaveatsWithNames(ctx context.Context, caveatNames []string) ([]datastore.RevisionedCaveat, error) {
...
func (rwt *natsReadWriteTx) WriteCaveats(_ context.Context, caveats []*core.CaveatDefinition) error {
	rwt.mustLock()
	defer rwt.Unlock()
	tx, err := rwt.txSource()
	if err != nil {
...
func (rwt *natsReadWriteTx) writeCaveat(tx *memdb.Txn, caveats []*core.CaveatDefinition) error {
...
func (rwt *natsReadWriteTx) DeleteCaveats(_ context.Context, names []string) error {
	rwt.mustLock()
	defer rwt.Unlock()
	tx, err := rwt.txSource()
	if err != nil {
