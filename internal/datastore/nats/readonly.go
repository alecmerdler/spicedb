...
func (r *natsReader) CountRelationships(ctx context.Context, name string) (int, error) {
...
func (r *natsReader) LookupCounters(ctx context.Context) ([]datastore.RelationshipCounter, error) {
	if r.initErr != nil {
...
func (r *natsReader) QueryRelationships(
	_ context.Context,
...
func (r *natsReader) ReverseQueryRelationships(
	_ context.Context,
...
func (r *natsReader) ReadNamespaceByName(_ context.Context, nsName string) (ns *core.NamespaceDefinition, lastWritten datastore.Revision, err error) {
	if r.initErr != nil {
...
func (r *natsReader) ListAllNamespaces(_ context.Context) ([]datastore.RevisionedNamespace, error) {
	if r.initErr != nil {
		return nil, r.initErr
	}
...
func (r *natsReader) LookupNamespacesWithNames(_ context.Context, nsNames []string) ([]datastore.RevisionedNamespace, error) {
	if r.initErr != nil {
		return nil, r.initErr
	}
...
var _ datastore.Reader = &natsReader{}
