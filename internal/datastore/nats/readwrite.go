...
type natsReadWriteTx struct {
	natsReader
	newRevision datastore.Revision
}

func (rwt *natsReadWriteTx) WriteRelationships(_ context.Context, mutations []tuple.RelationshipUpdate) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) toIntegrity(mutation tuple.RelationshipUpdate) *relationshipIntegrity {
...
func (rwt *natsReadWriteTx) write(tx *memdb.Txn, mutations ...tuple.RelationshipUpdate) error {
	// Apply the mutations
...
func (rwt *natsReadWriteTx) toCaveatReference(mutation tuple.RelationshipUpdate) *contextualizedCaveat {
...
func (rwt *natsReadWriteTx) DeleteRelationships(_ context.Context, filter *v1.RelationshipFilter, opts ...options.DeleteOptionsOption) (bool, error) {
	rwt.mustLock()
	defer rwt.Unlock()
...
// caller must already hold the concurrent access lock
func (rwt *natsReadWriteTx) deleteWithLock(tx *memdb.Txn, filter *v1.RelationshipFilter, limit uint64) (bool, error) {
...
func (rwt *natsReadWriteTx) RegisterCounter(ctx context.Context, name string, filter *core.RelationshipFilter) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) UnregisterCounter(ctx context.Context, name string) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) StoreCounterValue(ctx context.Context, name string, value int, computedAtRevision datastore.Revision) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) WriteNamespaces(_ context.Context, newConfigs ...*core.NamespaceDefinition) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) DeleteNamespaces(_ context.Context, nsNames ...string) error {
	rwt.mustLock()
	defer rwt.Unlock()
...
func (rwt *natsReadWriteTx) BulkLoad(ctx context.Context, iter datastore.BulkWriteRelationshipSource) (uint64, error) {
...
var _ datastore.ReadWriteTransaction = &natsReadWriteTx{}
